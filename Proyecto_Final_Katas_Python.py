...
def contar_palabras(texto):
    ...
    Returns:
        (dict): Resultado de la solicitud pedida.
...
def reemplazar_palabras(texto, palabra_original, palabra_nueva):
    ...
    """
    Reemplaza palabras de un texto dado

    Args:
        texto (str): Texto de entrada
    
    Returns:
        (str): Resultado de la solicitud pedida.
    """
...
def eliminar_palabra(texto, palabra_a_eliminar):
    ...
    """
        Elimina palabras de un texto dado
